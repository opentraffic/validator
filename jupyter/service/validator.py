...
PYTHONPATH=PYTHONPATH:../../valhalla/valhalla/.libs REDIS_HOST=localhost pdb py/reporter_service.py ../../conf/manila.json localhost:8002
...
class SegmentMatcherHandler(BaseHTTPRequestHandler):
  ...
  def handle_request(self, post):
    ...
    #hand it back
    return 200, json.dumps(segments)
